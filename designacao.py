...
limpa_tela()
cabecalho()
opcao = input("\nDeseja realizar a Designação Automática? (S/N): ")
...
while opcao.lower() == 's':
    ...
    exibe_saldo()
    opcao = input("\nDeseja realizar outra Designação Automática? (S/N): ")
...
def menu():
    ...
    print("4 - FECHAR/ABRIR DISTRIBUIÇÃO")
    print("5 - RELATÓRIO")
    ...
    if escolha == '1':
        ...
        print("\n")
        print("FECHAR/ABRIR DISTRIBUIÇÃO")
        print("\n")
